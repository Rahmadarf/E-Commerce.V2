        ...
        <header className="bg-white shadow-sm sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    </div>) : (<span className='text-blue-700 text-3xl md:text-4xl font-bold'>EzShop</span> )}
                                ...
                                <Link
                                    ...
                                    onClick={(e) => {
                                        if (!isAllowed) {
                                            ...
                                            showNotification('Fitur tidak tersedia', 'error')
                                        }
                                    }}
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <Tooltip title="Account" arrow>
                            <Link onClick={() => showNotification('Fitur tidak tersedia', 'error')} to="/account" className="text-gray-600 hover:text-blue-700 p-1">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
